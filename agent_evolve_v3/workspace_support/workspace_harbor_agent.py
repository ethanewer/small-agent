...
REMOTE_WORKSPACE_ROOT = "/tmp/agent-evolve-v3-workspace"
...
class WorkspaceHarborAgent(HarborBaseAgent):
    ...
    @staticmethod
    def name() -> str:
        return "agent-evolve-v3-workspace"
    ...
    async def run(self, instruction: str, environment: Any, context: Any) -> None:
        ...
        repo_root = _require_env_path(env_name="AGENT_EVOLVE_V3_REPO_ROOT")
    ...
    async def _ensure_workspace_available(self, *, environment: Any) -> None:
        workspace_root = _require_env_path(env_name="AGENT_EVOLVE_V3_WORKSPACE_PATH")
        repo_root = _require_env_path(env_name="AGENT_EVOLVE_V3_REPO_ROOT")
