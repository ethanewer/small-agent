...
try:
    from agent_evolve_v2.workspace_support.workspace_agent_types import (
...
class WorkspaceMetadata:
    baseline: str
    created_from: str
    benchmark_cache_root: str | None = None
...
def load_workspace_metadata(*, workspace_root: Path) -> WorkspaceMetadata:
    ...
    return WorkspaceMetadata(
        ...
        benchmark_cache_root=_optional_text(value=payload.get("benchmark_cache_root")),
